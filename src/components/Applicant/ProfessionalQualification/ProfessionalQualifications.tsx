...
const ProfessionalQualifications: React.FC = () => {
  ...
  // Extract applicantId from session
  useEffect(() => {
  ...
  const handleSave = async (data: ProfessionalQualification) => {
    ...
    try {
      const url = `/api/applicant/professional-qualification/${applicantId}`;
      ...
      const payload = {
        ...
        creator_id: 1, // replace with real user id
        updator_id: 1, // replace with real user id
      };
